...
let questions = [
  {
    ...
    answer: "c. You should use your thumb of non-dominant hand to push the blade",
    options: [
    "a. Switch to another side of the pencil after you have sharpened one side",
    "b. To make a sharp tip, it is always better to cut thicker wood",
    "c. You should use your thumb of non-dominant hand to push the blade"
    ],
    correctoutput: "Correct! Good job!",
    wrongoutput: "Incorrect. You should rotate the pencil shaft with each swipe of blade; when you get close to the inncer core, you should do thinner shaving. Answer c is the only correct answer."
  },
  {
    numb: 2,
